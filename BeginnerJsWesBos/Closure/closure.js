...
function createGreeting(greeting = '') {
	...
	return function(name) {  //inner scope here
...
function createGame(gameName) {//when you create a new game you create an empty score variable 
	let score = 0;
	return function win() { // this inner function will increment it
		score++; 
